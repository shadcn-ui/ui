...
export default async function BlocksPage() {
  ...
  return (
    <div className="gap-3 md:flex md:flex-row-reverse md:items-start">
      <ThemesSwitcher
        themes={themes}
        className="fixed inset-x-0 bottom-0 z-40 flex bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 lg:sticky lg:bottom-auto lg:top-20 mt-12"
      />
