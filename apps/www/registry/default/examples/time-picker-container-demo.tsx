    ...
    <div className={"flex w-full select-none flex-col items-center justify-center"}>
      <TimePickerContainer onTimeChange={(v)=>setTime(v)}>
        <TimePicker
          ...
          suffixLabel={(value)=><span className={"w-20 text-center"}>{value}d</span>}
          value={3}
        />
        <TimePicker
           className={"w-full"}
          ...
          suffixLabel={(value)=><span className={"w-20 text-center"}>{value}h</span>}
          value={3}
        />
        <TimePicker
           className={"w-full"}
          ...
          suffixLabel={(value)=><span className={"w-20 text-center"}>{value}min</span>}
          value={1}
        />
      </TimePickerContainer>
