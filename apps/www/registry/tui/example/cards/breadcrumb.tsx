  ...
  return (
    <Card>
      ...
      <CardContent>
        ...
        <div className="mt-14 font-bold text-primary pb-6">Full Width Bar</div>
        ...
        <div className="mt-14 font-bold text-primary pb-6">Simple With Chevron</div>
        ...
        <div className="mt-14 font-bold text-primary pb-6">Simple with slashes</div>
