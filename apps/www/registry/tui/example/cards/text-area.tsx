...
export function CardsTextArea() {
  ...
  const IconButton = [
    ...
    { bg: "bg-transparent", label: "I feel nothing", icon: "" }
  ]
  ...
  return (
    <Card className="">
      ...
      <CardContent>
        ...
        <div className="text-m mt-3 font-bold text-primary">With underline and actions</div>
        <Textarea placeholder="Add your comment..." iconStyle='h-5 w-5 text-gray-400' color="indigo" widthForUl="w-56" attachIcon='paperclip-solid' icon="face-smile-beam-solid" submitButtonName="Post" iconButton={IconButton} showIconForTextArea={true} image="https://images.unsplash.com/photo-1550525811-e5869dd03032?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" />
