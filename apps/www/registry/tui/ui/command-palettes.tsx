        ...
        return (
            <>
                <div className={cn((commandPalettesVariants({}), className))}>
                    {withInputIcon ? <Input alignIcon="left" onKeyDown={onKeyDown} className={cn(`h-12 rounded-none  border-primary/20 ${open ? "rounded-t-lg border-b-0" : "rounded-lg"}`, bgColor(backgroundColor), className)} iconStyle="h-5 w-5" borderStyleForAddOn="iconWithLabel" icon="magnifying-glass-duotone" textColor="gray" placeholder="Search..." />
