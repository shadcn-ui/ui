        ...
        return (
            <>
                <div className={cn((commandPalettesVariants({}), className))}>
                    {withInputIcon ? <Input onKeyDown={onKeyDown} className={cn(`h-12 rounded-none  border-primary/20 ${open ? "rounded-t-lg border-b-0" : "rounded-lg"}`, bgColor(backgroundColor), className)} borderStyleForAddOn="iconWithLabel" icon="magnifying-glass-duotone" placeholder="Search..." />
