...
export const Index: Record<string, any> = {
  "default": {
    ...
    "multi-select-basic": {
      ...
      type: "components:example",
      registryDependencies: ["multi-select"],
      component: React.lazy(() => import("@/registry/new-york/example/multi-select-basic")),
      files: ["registry/new-york/example/multi-select-basic.tsx"],
    },
    "multi-select-filter": {
      name: "multi-select-filter",
      type: "components:example",
      registryDependencies: ["multi-select"],
      component: React.lazy(() => import("@/registry/new-york/example/multi-select-filter")),
      files: ["registry/new-york/example/multi-select-filter.tsx"],
    },
    "multi-select-controllable-search": {
      name: "multi-select-controllable-search",
      type: "components:example",
      registryDependencies: ["multi-select"],
      component: React.lazy(() => import("@/registry/new-york/example/multi-select-controllable-search")),
      files: ["registry/new-york/example/multi-select-controllable-search.tsx"],
    },
    "multi-select-input-custom": {
      name: "multi-select-input-custom",
      type: "components:example",
      registryDependencies: ["multi-select"],
      component: React.lazy(() => import("@/registry/new-york/example/multi-select-input-custom")),
      files: ["registry/new-york/example/multi-select-input-custom.tsx"],
    },
    "multi-select-limit-count": {
      name: "multi-select-limit-count",
      type: "components:example",
      registryDependencies: ["multi-select"],
      component: React.lazy(() => import("@/registry/new-york/example/multi-select-limit-count")),
      files: ["registry/new-york/example/multi-select-limit-count.tsx"],
    },
    "multi-select-limit-display-length": {
      name: "multi-select-limit-display-length",
      type: "components:example",
      registryDependencies: ["multi-select"],
      component: React.lazy(() => import("@/registry/new-york/example/multi-select-limit-display-length")),
      files: ["registry/new-york/example/multi-select-limit-display-length.tsx"],
    },
    "multi-select-form": {
      name: "multi-select-form",
      type: "components:example",
