...
export const Index: Record<string, any> = {
  "default": {
    ...
    "switch-small": {
      ...
      type: "components:example",
      registryDependencies: ["switch"],
      component: React.lazy(() => import("@/registry/default/example/switch-small")),
      files: ["registry/default/example/switch-small.tsx"],
    },
    "switch-base": {
      name: "switch-base",
      type: "components:example",
      registryDependencies: ["switch"],
      component: React.lazy(() => import("@/registry/default/example/switch-base")),
      files: ["registry/default/example/switch-base.tsx"],
    },
    "switch-large": {
      name: "switch-large",
      type: "components:example",
      registryDependencies: ["switch"],
      component: React.lazy(() => import("@/registry/default/example/switch-large")),
      files: ["registry/default/example/switch-large.tsx"],
    },
    "table-demo": {
      name: "table-demo",
      type: "components:example",
    ...
    "switch-small": {
      ...
      type: "components:example",
      registryDependencies: ["switch"],
      component: React.lazy(() => import("@/registry/new-york/example/switch-small")),
      files: ["registry/new-york/example/switch-small.tsx"],
    },
    "switch-base": {
      name: "switch-base",
      type: "components:example",
      registryDependencies: ["switch"],
      component: React.lazy(() => import("@/registry/new-york/example/switch-base")),
      files: ["registry/new-york/example/switch-base.tsx"],
    },
    "switch-large": {
      name: "switch-large",
      type: "components:example",
      registryDependencies: ["switch"],
      component: React.lazy(() => import("@/registry/new-york/example/switch-large")),
      files: ["registry/new-york/example/switch-large.tsx"],
    },
    "table-demo": {
      name: "table-demo",
      type: "components:example",
