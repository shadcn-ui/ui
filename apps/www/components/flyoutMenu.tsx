...
export const StackedWithFooterAction = () => {
  ...
  return (
    <CardContent className='h-[36rem] w-full'>
      <CardHeader>
        <CardTitle>
          Flyout Menus
        </CardTitle>
  ...
  return (
    <CardContent className='h-[36rem] w-full'>
      ...
      <Popover>
        ...
        <PopoverContent className="z-10 flex w-screen max-w-max border-none p-0 pt-2 shadow-none">
...
export const FullWidth = () => {
  ...
  return (
    <CardContent className='mt-4 h-screen w-full px-0'>
      <CardHeader>
        <CardDescription>
          Full width
        </CardDescription>
      ...
      <Popover>
        <div className="z-0 w-full shadow-none">
          <div className='w-full bg-white py-5 shadow-none '>
            <PopoverTrigger asChild>
              <div className='w-full max-w-full border-0 px-6 data-[state=closed]:pb-6 data-[state=open]:pb-0 data-[state=closed]:shadow-md data-[state=open]:shadow-none lg:px-8'>
                <Button variant="ghost" className='inline-flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900 shadow-none' icon="chevron-down-regular" alignIcon='right'>
                  Solutions
                </Button>
              </div>
            </PopoverTrigger>
            <PopoverContent
              ...
              sideOffset={0} className="shadow-b-sm  shadow-x-none z-0 mx-[0.10rem] mt-5 w-full appearance-none rounded-none border-0 p-0 pr-[2.85rem] ring-0 ring-gray-900/5">
              <div className="mx-auto grid max-w-[83.20rem] grid-cols-1 gap-2 p-6 shadow-none sm:grid-cols-2 sm:gap-x-6 sm:gap-y-0 sm:py-10 lg:grid-cols-4 lg:gap-4 lg:px-8 xl:gap-8">
                {solutions.map((item) => (
                  <div
                    key={item.name}
              ...
              <div className="w-full bg-gray-50">
                <div className="mx-auto max-w-full p-0">
                  <div className="grid w-full grid-cols-1 divide-y divide-gray-900/5 sm:grid-cols-3 sm:divide-x sm:divide-y-0 sm:border-x sm:border-gray-900/5">
...
export const FullWidthTwoColumns = () => {
  ...
  return (
    <CardContent className='mt-4 h-screen w-full px-0'>
      ...
      <Popover>
        <div className="z-0 w-full shadow-none">
          <div className='appearance-none border-0 bg-white py-5 shadow-none'>
            <PopoverTrigger asChild>
              <div className='w-full max-w-full border-0 px-6 pb-4 data-[state=closed]:shadow-md data-[state=open]:shadow-none lg:px-8'>
                <Button variant="ghost" className='inline-flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900 shadow-none' icon="chevron-down-regular" alignIcon='right'>
                  Solutions
                </Button>
              </div>
            ...
            <PopoverContent
              side="top" align='start' alignOffset={-2}
              sideOffset={0} className="shadow-b-lg border-t-none z-0 ml-[0.20rem] mt-5 w-full appearance-none rounded-t-none border-0 bg-white p-1 pr-[2.85rem] ring-0 ring-gray-900/5">
              <div className="grid w-full max-w-[80rem] grid-cols-1 gap-x-8 gap-y-10 px-6 py-10 lg:grid-cols-2 lg:px-8">
