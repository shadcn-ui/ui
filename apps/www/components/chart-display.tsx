...
export async function ChartDisplay({
  ...
  return (
    ...
    >
      <ChartToolbar
        chart={chart}
        className="relative inset-x-0 top-0 z-20 flex justify-end rounded-t-xl border bg-card px-4 py-3 text-card-foreground shadow transition-all duration-200 ease-in-out after:absolute after:inset-x-0 after:-bottom-2 after:h-2 after:border-t after:border-border after:bg-card md:absolute md:-translate-y-8 md:opacity-0 group-hover:md:-translate-y-12 group-hover:md:opacity-100"
      />
