...
function PageHeaderHeading({
  ...
  return (
    <h1
      className={cn(
        "text-2xl sm:text-3xl font-bold leading-tight tracking-tighter md:text-4xl lg:leading-[1.1]",
        className
      )}
      {...props}
    />
...
function PageHeaderDescription({
  ...
  return (
    <p
      className={cn(
        "max-w-2xl text-balance text-base sm:text-lg font-light text-foreground",
        className
      )}
      {...props}
    />
