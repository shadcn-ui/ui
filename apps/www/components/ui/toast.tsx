...
const toastVariants = cva(
  [
    "absolute w-full items-start rounded-md border border-b-4 border-slate-900 bg-white p-3 shadow-lg dark:border-slate-700 dark:bg-slate-800 md:max-w-[390px] pointer-events-auto",
...
const Toast: React.FC<ToastProps> = ({ className, position, ...props }) => (
...
> = ({ className, position, ...props }) => (
  <ToastPrimitives.Viewport
    className={cn("pointer-events-none fixed inset-4 z-50", className)}
    {...props}
  />
)
