...
If you're using `npm`, you can install shadcn/ui dependencies with a flag. The `shadcn` CLI will prompt you to select a flag when you run it.
...
| [recharts](https://www.npmjs.com/package/recharts)                                 | ✅     | Use version 2.13.0. See [release notes](https://github.com/recharts/recharts/discussions/5105) |
...
| [vaul](https://www.npmjs.com/package/vaul)                                         | 🚧     | See [PR #498](https://github.com/emilkowalski/vaul/pull/498)                                   |
