...
> Keep in mind this might generate a theme flash on page load since this uses Local Storage to persist the theme. If you want to avoid this, you should a SSR option such as next.js.
...
```tsx {14,26-34} title="components/theme-toggle.tsx"
