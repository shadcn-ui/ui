...
<Accordion collapsible>
  <AccordionItem value="faq-1">
    ...
    <AccordionContent>
      <p>
        shadcn/ui leverages the headless components approach. This means the
      ...
      <p className="mt-4">
        ...
        coupled with the implementation of the library.
      </p>
    </AccordionContent>
  </AccordionItem>
</Accordion>
...
_A shared, composable interface means it's predictable for both your team and LLMs. You are not learning different APIs for every component. Even for third-party ones._
