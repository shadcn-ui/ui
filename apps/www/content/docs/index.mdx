...
You can use any framework that supports React. [Next.js](https://nextjs.org/), [Astro](https://astro.build/), [Remix](https://remix.run/), [Gatsby](https://www.gatsbyjs.com/) etc.
