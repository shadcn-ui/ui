...
You can use any framework that supports React. [Next.js](https://ui.shadcn.com/docs/installation/next), Astro, [Remix](https://ui.shadcn.com/docs/installation/remix), Gatsby etc.
