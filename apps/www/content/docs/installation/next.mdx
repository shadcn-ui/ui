...
<Callout className="mt-6">
  Note: Using CLI version 0.8.0+ with Next.js automatically detects tailwind
  config, global.css and custom path aliases. You will only be prompted for
  `style`, `baseColor` and `cssVariables`.
</Callout>
