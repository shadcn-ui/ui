...
Configuration to help the CLI understand how Tailwind CSS is set up in your project. Check the [installation section](/docs/installation) for how to set up Tailwind CSS.
...
For more information, check the [theming section](/docs/theming).
