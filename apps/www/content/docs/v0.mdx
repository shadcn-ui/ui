...
Every component on ui.shadcn.com is editable in [v0 by Vercel](https://v0.dev). This allows you to easily customize in natural language and paste into your app.
