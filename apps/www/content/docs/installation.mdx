...
<Tabs defaultValue="nextjs" className="relative mr-auto w-full">
  <div className="flex items-center justify-between pb-3">
    ...
    <TabsContent value="nextjs" className="relative rounded-md">
    	<Steps>
    	### Create project
    ...
    <TabsContent value="vite" className="relative rounded-md">
