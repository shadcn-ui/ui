...
We've revisted the dark mode colors and updated them to be more accessible. If you're running an existing Tailwind v4 project, see the [Dark Mode](/docs/dark-mode/changelog) page for a list of updated colors.
