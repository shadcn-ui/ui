...
If you'd like to see an example of a registry, we can have a [template project](https://github.com/shadcn-ui/registry-template) for you to use as a starting point.
