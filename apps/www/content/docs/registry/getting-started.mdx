...
If you're starting a new registry project, you can use the [registry template](https://github.com/shadcn-ui/registry-template-v4) as a starting point. We have already configured it for you.
