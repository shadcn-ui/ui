...
<ComponentPreview name="slider-horizontal-demo" description="A horizontal slider component." />

### Vertical slider

<ComponentPreview name="slider-vertical-demo" description="A vertical slider component." />
