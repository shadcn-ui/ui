...
Clicking a `SidebarMenuButton` will automatically close the sidebar on mobile.
...
Clicking a `SidebarMenuSubButton` will automatically close the sidebar on mobile.
