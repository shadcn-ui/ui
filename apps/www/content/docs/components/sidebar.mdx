...
@layer base {
  :root {
    --sidebar-background: light-dark(hsl(0 0% 98%), hsl(240 5.9% 10%));
    --sidebar-foreground: light-dark(hsl(240 5.3% 26.1%), hsl(240 4.8% 95.9%));
    --sidebar-primary: light-dark(hsl(240 5.9% 10%), hsl(224.3 76.3% 48%));
    --sidebar-primary-foreground: light-dark(hsl(0 0% 98%), hsl(0 0% 100%));
    --sidebar-accent: light-dark(hsl(240 4.8% 95.9%), hsl(240 3.7% 15.9%));
    --sidebar-accent-foreground: light-dark(
      hsl(240 5.9% 10%),
      hsl(240 4.8% 95.9%)
    );
    --sidebar-border: light-dark(hsl(220 13% 91%), hsl(240 3.7% 15.9%));
...
@layer base {
  :root {
    --sidebar-background: light-dark(hsl(0 0% 98%), hsl(240 5.9% 10%));
    --sidebar-foreground: light-dark(hsl(240 5.3% 26.1%), hsl(240 4.8% 95.9%));
    --sidebar-primary: light-dark(hsl(240 5.9% 10%), hsl(0 0% 98%));
    --sidebar-primary-foreground: light-dark(hsl(0 0% 98%), hsl(240 5.9% 10%));
    --sidebar-accent: light-dark(hsl(240 4.8% 95.9%), hsl(240 3.7% 15.9%));
    --sidebar-accent-foreground: light-dark(
      hsl(240 5.9% 10%),
      hsl(240 4.8% 95.9%)
