...
<ComponentPreview name="dialog-position-demo" />

## Sizes

DialogContent provides `small`, `medium`, `large`, `extra-large`, `super-large`, `ultra-large`, and `full` sizes as alternatives to the standard.
