...
Implement filtering manually if you need a custom search logic or if you call an API to perform the search.

<ComponentPreview name="command-custom-filtering" />
