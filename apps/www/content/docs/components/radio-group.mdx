...
```tsx
<RadioGroup defaultValue="option-one">
  <RadioGroupCard value="option-one" id="option-one">
    <Label htmlFor="option-one">Option One</Label>
    <p>Description for option one</p>
  </RadioGroupCard>
  <RadioGroupCard value="option-two" id="option-two">
    <Label htmlFor="option-one">Option Two</Label>
    <p>Description for option two</p>
  </RadioGroupCard>
</RadioGroup>
```
