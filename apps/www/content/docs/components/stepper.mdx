...
<ComponentPreview name="stepper-scroll-tracking" />
...
<ComponentPreview name="stepper-custom-styles" />
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      type: "number",
      description: "The previous active step. It allows us to know which was the previous active step",
    }
  ]}
/>
