...
You can use the Props `itemClicked`, `itemHoverEnter` and `itemHoverLeave` to add interactivity for the legend items.

```tsx
<ChartLegend
  content={
    <ChartLegendContent
      itemClicke={console.log}
      itemHoverLeave={console.log}
