...
```tsx
<Button asChild>
  <Link href="/login">Login</Link>  // It refreshes the documentation page by clicking here, in href '/login' functionality should be prevented using the default behavior
</Button>
```
