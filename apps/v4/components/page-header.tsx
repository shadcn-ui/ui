...
function PageHeaderHeading({
  ...
  return (
    <h1
      className={cn(
        "text-primary leading-tighter max-w-3xl text-3xl font-semibold tracking-tight text-balance lg:leading-[1.1] lg:font-semibold xl:text-4xl xl:tracking-tighter",
        className
      )}
      {...props}
    />
