  ...
  return (
    ...
    >
      ...
      <div className="flex w-full flex-col items-center justify-center gap-1">
        ...
        <span className="text-muted-foreground group-hover:text-foreground group-data-[last-copied=true]:text-primary font-mono text-xs tabular-nums transition-colors lg:hidden">
          {color.scale}
        </span>
      </div>
    </button>
