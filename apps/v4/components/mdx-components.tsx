...
export const mdxComponents = {
  h1: ({ className, ...props }: React.ComponentProps<"h1">) => (
    <h1
      className={cn(
        "font-heading mt-2 scroll-m-20 text-3xl font-bold tracking-tight",
        className
      )}
      {...props}
    />
  ...
  Steps: ({ ...props }) => (
    <div
      className="[&>h3]:step steps mb-12 ml-4 border-l pl-8 [counter-reset:step] *:[h3]:first:!mt-0"
      {...props}
    />
  ),
  Image: ({
  ...
  LinkedCard: ({ className, ...props }: React.ComponentProps<typeof Link>) => (
    <Link
      className={cn(
        "from-card to-muted/50 text-card-foreground hover:bg-muted/30 flex w-full flex-col items-center rounded-xl border bg-gradient-to-b p-6 transition-colors sm:p-10",
        className
      )}
      {...props}
    />
