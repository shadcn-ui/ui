...
export default async function Page(props: {
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-[calc(var(--header-height)+1px)] z-30 ml-auto hidden h-[90svh] w-(--sidebar-width) flex-col gap-4 overflow-hidden overscroll-none pb-8 lg:flex">
