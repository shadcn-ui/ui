...
function PickerTrigger({ className, ...props }: MenuPrimitive.Trigger.Props) {
  return (
    <MenuPrimitive.Trigger
      ...
      className={cn(
        "relative w-full shrink-0 touch-manipulation rounded-xl bg-muted/50 p-2 ring ring-black/10 select-none hover:bg-muted disabled:opacity-50 data-popup-open:bg-muted md:w-full md:rounded-lg",
        className
      )}
      {...props}
    />
