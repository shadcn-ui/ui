  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className="pointer-events-none block rounded-full bg-background shadow-sm ring-0 transition-transform not-dark:bg-clip-padding group-data-[size=default]/switch:h-4 group-data-[size=default]/switch:w-7 group-data-[size=sm]/switch:h-3 group-data-[size=sm]/switch:w-4 group-data-[size=default]/switch:data-checked:translate-x-[calc(100%-16px)] group-data-[size=sm]/switch:data-checked:translate-x-[calc(100%-8px)] dark:data-checked:bg-primary-foreground group-data-[size=default]/switch:data-unchecked:translate-x-0 group-data-[size=sm]/switch:data-unchecked:translate-x-0 dark:data-unchecked:bg-foreground"
      />
    </SwitchPrimitive.Root>
  )
}
