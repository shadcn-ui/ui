...
import {
  ...
  InputGroupButton,
  InputGroupInput,
} from "@/styles/react-aria-nova/ui-rtl/input-group"
...
function ComboboxChips({
  ...
  return (
    <div
      ...
      className={cn(
        "flex min-h-8 flex-wrap items-center gap-1 rounded-lg border border-input bg-transparent bg-clip-padding px-2.5 py-1 text-sm transition-colors focus-within:border-ring focus-within:ring-3 focus-within:ring-ring/50 has-data-[slot=combobox-chip]:px-1 has-data-invalid:border-destructive has-data-invalid:ring-3 has-data-invalid:ring-destructive/20 dark:bg-input/30 dark:has-data-invalid:border-destructive/50 dark:has-data-invalid:ring-destructive/40",
        className
      )}
      {...props}
    >
