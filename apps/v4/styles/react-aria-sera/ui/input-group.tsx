...
import { Button } from "@/styles/react-aria-sera/ui/button"
import { Input } from "@/styles/react-aria-sera/ui/input"
import { Textarea } from "@/styles/react-aria-sera/ui/textarea"
...
function InputGroupInput({
  ...
  return (
    <Input
      ...
      className={cn(
        "flex-1 border-0 bg-transparent ring-0 group-has-[>[data-align=inline-end]]/input-group:pr-2 group-has-[>[data-align=inline-start]]/input-group:pl-2 focus-visible:ring-0 dark:bg-transparent data-invalid:ring-0",
        className
      )}
      {...props}
    />
...
function InputGroupTextarea({
  ...
  return (
    <Textarea
      data-slot="input-group-control"
      className={cn(
        "flex-1 resize-none border-0 bg-transparent py-2.5 ring-0 focus-visible:ring-0 dark:bg-transparent data-invalid:ring-0",
        className
      )}
      {...props}
    />
