...
import { Button } from "@/styles/react-aria-mira/ui/button"
import { Input } from "@/styles/react-aria-mira/ui/input"
import { Textarea } from "@/styles/react-aria-mira/ui/textarea"
...
function InputGroupTextarea({
  ...
  return (
    <Textarea
      data-slot="input-group-control"
      className={cn(
        "flex-1 resize-none rounded-none border-0 bg-transparent py-2 shadow-none ring-0 focus-visible:ring-0 dark:bg-transparent data-invalid:ring-0",
        className
      )}
      {...props}
    />
