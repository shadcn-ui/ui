...
function DrawerSwipeArea({
  ...
  return (
    <DrawerPrimitive.SwipeArea
      ...
      className={cn(
        "fixed z-50",
        "data-[swipe-direction=left]:inset-y-0 data-[swipe-direction=left]:end-0 data-[swipe-direction=left]:w-10",
        "data-[swipe-direction=right]:inset-y-0 data-[swipe-direction=right]:start-0 data-[swipe-direction=right]:w-10",
