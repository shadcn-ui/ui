      ...
      >
        <DrawerPrimitive.Popup
          ...
          className={cn(
            ...
            "after:pointer-events-none after:absolute after:bg-(--drawer-bleed-background,var(--color-popover)) data-[swipe-direction=down]:after:inset-x-0 data-[swipe-direction=down]:after:top-full data-[swipe-direction=down]:after:h-(--bleed-y) data-[swipe-direction=left]:after:inset-y-0 data-[swipe-direction=left]:after:end-full data-[swipe-direction=left]:after:w-(--bleed-x) data-[swipe-direction=right]:after:inset-y-0 data-[swipe-direction=right]:after:start-full data-[swipe-direction=right]:after:w-(--bleed-x) data-[swipe-direction=up]:after:inset-x-0 data-[swipe-direction=up]:after:bottom-full data-[swipe-direction=up]:after:h-(--bleed-y)",
            ...
            // Direction: left.
            "data-[swipe-direction=left]:origin-start data-[swipe-direction=left]:start-0 data-[swipe-direction=left]:[--closed-transform:translate3d(calc(-100%-var(--drawer-inset,0px)-2px),0,0)] data-[swipe-direction=left]:[--translate-x:calc(var(--drawer-swipe-movement-x)+var(--stack-peek-offset)+(var(--stack-shrink)*var(--stack-width)))]",
            // Direction: right.
            "data-[swipe-direction=right]:origin-end data-[swipe-direction=right]:end-0 data-[swipe-direction=right]:[--closed-transform:translate3d(calc(100%+var(--drawer-inset,0px)+2px),0,0)] data-[swipe-direction=right]:[--translate-x:calc(var(--drawer-swipe-movement-x)-var(--stack-peek-offset)-(var(--stack-shrink)*var(--stack-width)))]",
            className
          )}
          {...props}
        >
...
function DrawerHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex shrink-0 flex-col gap-0.5 p-4 pb-0 group-data-[swipe-axis=y]/drawer-content:text-center md:gap-0.5 md:text-start",
        className
      )}
      {...props}
    />
