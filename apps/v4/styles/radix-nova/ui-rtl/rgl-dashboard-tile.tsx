...
function AreaChartTile() {
  ...
  return (
    <Card className="flex h-full flex-col">
      ...
      <CardContent className="h-0 flex-1 ps-0">
        ...
        <table className="w-full caption-bottom text-sm">
          <thead>
            <tr className="border-b border-border">
              <th className="h-10 px-2 text-start font-medium text-muted-foreground">
                Product
              </th>
              <th className="h-10 px-2 text-start font-medium text-muted-foreground">
                Status
              </th>
              <th className="h-10 px-2 text-end font-medium text-muted-foreground">
                Revenue
              </th>
            </tr>
          </thead>
          <tbody>
            {tableRows.map((row) => (
              <tr key={row.id} className="border-b border-border/60">
                ...
                <td className="p-2 text-end align-middle tabular-nums">
                  {row.revenue}
                </td>
              </tr>
            ))}
