...
function ProgressIndicator({
  ...
  return (
    <ProgressPrimitive.Indicator
      ...
      className={cn(
        "h-full bg-primary transition-all data-[indeterminate]:w-full data-[indeterminate]:shimmer data-[state=indeterminate]:w-full data-[state=indeterminate]:shimmer",
        className
      )}
      {...props}
    />
