...
function SidebarMenuItem({
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className="pointer-events-none absolute inset-y-0 -start-1.5 w-1 rounded-full bg-sidebar-accent-foreground opacity-0 peer-data-active/menu-button:opacity-100"
      />
    </li>
  )
}
