...
import { Button } from "@/styles/react-aria-luma/ui/button"
import {
  InputGroup,
  InputGroupAddon,
  InputGroupButton,
...
function ComboboxItem<T extends object>({
  ...
  return (
    <ListBoxItemPrimitive
      ...
      className={cn(
        "relative flex w-full cursor-default items-center gap-2.5 rounded-2xl py-2 pr-8 pl-3 text-sm font-medium outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 data-highlighted:bg-accent data-highlighted:text-accent-foreground not-data-[variant=destructive]:data-highlighted:**:text-accent-foreground [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
...
function ComboboxChips({
  ...
  return (
    <div
      ...
      className={cn(
        "flex min-h-9 flex-wrap items-center gap-1.5 rounded-3xl border border-transparent bg-input/50 bg-clip-padding px-3 py-1.5 text-sm transition-[color,box-shadow,background-color] focus-within:border-ring focus-within:ring-3 focus-within:ring-ring/30 has-data-[slot=combobox-chip]:px-1.5 has-data-invalid:border-destructive has-data-invalid:ring-3 has-data-invalid:ring-destructive/20 dark:has-data-invalid:border-destructive/50 dark:has-data-invalid:ring-destructive/40",
        className
      )}
      {...props}
    >
