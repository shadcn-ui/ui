...
import { Input } from "@/styles/react-aria-luma/ui/input"
import { Textarea } from "@/styles/react-aria-luma/ui/textarea"
...
function InputGroupInput({
  ...
  return (
    <Input
      ...
      className={cn(
        "flex-1 rounded-none border-0 bg-transparent shadow-none ring-0 focus-visible:ring-0 dark:bg-transparent data-invalid:ring-0",
        className
      )}
      {...props}
    />
...
function InputGroupTextarea({
  ...
  return (
    <Textarea
      data-slot="input-group-control"
      className={cn(
        "flex-1 resize-none rounded-none border-0 bg-transparent py-2.5 shadow-none ring-0 focus-visible:ring-0 dark:bg-transparent data-invalid:ring-0",
        className
      )}
      {...props}
    />
