...
import { Collapsible } from "@/registry/aria-vega/ui/collapsible"
import { Marker, MarkerContent } from "@/registry/aria-vega/ui/marker"
...
function BubbleButtonLinks() {
  return (
    <Example title="Button & Links">
      <div className="flex w-full max-w-md flex-col gap-8">
        <Bubble>
          <BubbleContent render={(props) => <a href="#" {...props} />}>
