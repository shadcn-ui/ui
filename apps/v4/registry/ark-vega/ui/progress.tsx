...
>(({ className, ...props }, ref) => (
  <ProgressPrimitive.Track
    ...
    className={cn("bg-muted h-1.5 rounded-full col-span-full overflow-hidden", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <ProgressPrimitive.Range
    ...
    className={cn("bg-primary h-full rounded-[inherit] transition-all", className)}
    {...props}
  />
))
