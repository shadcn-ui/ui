...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Track
    ...
    className={cn("bg-muted rounded-full data-horizontal:h-1 data-horizontal:w-full data-vertical:h-full data-vertical:w-1 flex-1 overflow-hidden", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Thumb
    ...
    className={cn("border-ring ring-ring/50 relative size-3 rounded-full border bg-white transition-[color,box-shadow] after:absolute after:-inset-2 hover:ring-3 focus-visible:ring-3 focus-visible:outline-hidden active:ring-3", className)}
    {...props}
  />
))
