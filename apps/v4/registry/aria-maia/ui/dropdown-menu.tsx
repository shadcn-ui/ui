...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenu
      ...
      className={cn(
        "cn-menu-target cn-menu-translucent w-auto min-w-36 rounded-2xl bg-popover p-1 text-popover-foreground shadow-2xl ring-1 ring-foreground/5 duration-100",
        className
      )}
      placement={placement}
      crossOffset={crossOffset}
