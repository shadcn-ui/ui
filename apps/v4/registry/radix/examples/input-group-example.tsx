...
import { ButtonGroup, ButtonGroupText } from "@/registry/radix/ui/button-group"
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
    ...
    <CanvaFrame>
        <div className="flex w-full flex-wrap gap-12 pb-72 *:[div]:w-full *:[div]:max-w-sm">
          <div className="flex flex-col gap-10">
            ...
            <Field>
              <FieldLabel htmlFor="input-icon-both-10">
                Multiple Icons
              </FieldLabel>
              <InputGroup>
            ...
            <Field>
              <FieldLabel htmlFor="input-description-10">
                Description
              </FieldLabel>
              <InputGroup>
          ...
          <div className="flex flex-col gap-10">
            ...
            <Field>
              <FieldLabel htmlFor="input-addon-21">
                Addon (block-end)
              </FieldLabel>
              <InputGroup className="h-auto">
            ...
            <Field>
              <FieldLabel htmlFor="textarea-comment-33">
                Default Button
              </FieldLabel>
              <InputGroup>
                <InputGroupTextarea
          ...
          <div className="flex flex-col gap-10">
            <Field>
              <FieldLabel htmlFor="input-kbd-22">
          ...
          <div className="flex flex-col gap-10">
            ...
            <Field data-invalid="true">
              <FieldLabel htmlFor="textarea-header-footer-14">
                Invalid
              </FieldLabel>
              <InputGroup>
                <InputGroupTextarea
