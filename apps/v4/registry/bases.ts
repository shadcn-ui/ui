...
export const BASES: z.infer<typeof registryItemSchema>[] = [
  ...
  },
  {
    ...
    meta: {
      logo: "<svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'><path fill='currentColor' d='M12 2L2 19.5h4.5L12 9l5.5 10.5H22L12 2Z'/></svg>",
    },
  },
]
