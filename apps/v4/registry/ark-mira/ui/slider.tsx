...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Track
    ...
    className={cn("bg-muted rounded-md data-horizontal:h-3 data-horizontal:w-full data-vertical:h-full data-vertical:w-3 flex-1 overflow-hidden", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Thumb
    ...
    className={cn("border-primary ring-ring/30 size-4 rounded-md border bg-white shadow-sm transition-colors hover:ring-4 focus-visible:ring-4 focus-visible:outline-hidden", className)}
    {...props}
  />
))
