...
export const Index: Record<string, any> = {
  ...
  "inline-edit": {
    ...
    files: [
      {
        path: "registry/new-york-v4/ui/inline-edit.tsx",
        type: "registry:ui",
        target: "",
      },
    ],
    component: React.lazy(async () => {
      const mod = await import("@/registry/new-york-v4/ui/inline-edit.tsx")
      const exportName =
        Object.keys(mod).find(
          (key) =>
            typeof mod[key] === "function" || typeof mod[key] === "object"
  ...
  "inline-edit-demo": {
    ...
    description: "",
    type: "registry:example",
    registryDependencies: ["inline-edit"],
    files: [
      {
        path: "registry/new-york-v4/examples/inline-edit-demo.tsx",
        type: "registry:example",
        target: "",
      },
    ],
    component: React.lazy(async () => {
      const mod = await import(
        "@/registry/new-york-v4/examples/inline-edit-demo.tsx"
      )
      const exportName =
        Object.keys(mod).find(
          (key) =>
