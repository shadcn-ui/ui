...
export default function AccordionBorders() {
  return (
    <Accordion className="w-full">
      <AccordionItem value="billing" className="border px-4 first:rounded-t-lg last:rounded-b-lg">
      ...
      <AccordionItem value="security" className="border-x border-b px-4 last:rounded-b-lg">
      ...
      <AccordionItem value="integration" className="border-x border-b px-4 last:rounded-b-lg">
