    ...
    <Example title="With Borders">
      <Accordion className="mx-auto max-w-lg gap-4">
        <AccordionItem value="billing" className="rounded-lg border">
          <AccordionTrigger className="style-nova:px-2.5 style-nova:text-sm style-lyra:px-2 style-lyra:text-xs px-4 text-base font-medium">
            How does billing work?
          </AccordionTrigger>
          <AccordionContent className="text-muted-foreground style-nova:px-2.5 style-nova:text-sm style-lyra:px-2 style-lyra:text-xs px-4">
    ...
    <Example title="With Disabled">
      <Accordion className="mx-auto max-w-lg overflow-hidden rounded-lg border">
        <AccordionItem value="item-1" className="data-open:bg-muted/50 p-1">
          <AccordionTrigger className="style-nova:px-2.5 style-lyra:px-2 px-4">
            Can I access my account history?
          </AccordionTrigger>
          <AccordionContent className="style-nova:px-2.5 style-lyra:px-2 px-4">
