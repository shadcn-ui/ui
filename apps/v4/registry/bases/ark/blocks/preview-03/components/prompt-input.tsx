...
import { FieldGroup } from "@/registry/bases/ark/ui/field"
import {
  InputGroup,
  InputGroupAddon,
  InputGroupButton,
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-fit">
                <DropdownMenuGroup>
                  ...
                  <DropdownMenuItem value="take-screenshot">
                    <IconPlaceholder
                      lucide="MonitorIcon"
                ...
                <DropdownMenuGroup>
                  <DropdownMenuSub>
                    ...
                    <DropdownMenuSubContent>
                      <DropdownMenuItem value="agent-mode">
                        <IconPlaceholder
                          lucide="BotIcon"
                          tabler="IconRobot"
                      ...
                      <DropdownMenuItem value="add-sources">
                        <IconPlaceholder
                          lucide="BookOpenIcon"
                          tabler="IconBook"
                      ...
                      <DropdownMenuItem value="create-tasks">
                        <IconPlaceholder
                          lucide="CheckIcon"
                          tabler="IconCheck"
