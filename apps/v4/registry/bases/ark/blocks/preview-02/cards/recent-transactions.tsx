            ...
            <TableRow>
              ...
              <TableCell className="w-8">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent>
                    <DropdownMenuItem value="view-details">
                      View details
                    </DropdownMenuItem>
                    <DropdownMenuItem value="add-note">Add note</DropdownMenuItem>
                    <DropdownMenuItem value="categorize">
                      Categorize
                    </DropdownMenuItem>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem value="dispute">Dispute</DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>
              </TableCell>
            </TableRow>
