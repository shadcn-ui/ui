...
>(({ className, ...props }, ref) => (
  <DatePickerPrimitive.Input
    ...
    className={cn(
      "flex h-9 w-full flex-1 rounded-md border border-input bg-transparent px-3 py-2 text-sm shadow-xs outline-none transition-[border-color,box-shadow] duration-150",
...
>(({ className, children, ...props }, ref) => (
  <DatePickerPrimitive.PrevTrigger
    ...
    className={cn(
      "inline-flex size-8 items-center justify-center rounded-md border-transparent transition-colors hover:bg-accent focus-visible:ring-[3px] focus-visible:ring-ring/20 focus-visible:outline-none data-[disabled]:opacity-40 data-[disabled]:cursor-not-allowed [&_svg]:size-4",
      className
    )}
    {...props}
  >
...
>(({ className, ...props }, ref) => (
  <DatePickerPrimitive.TableCellTrigger
    ...
    className={cn(
      ...
      "focus-visible:outline-2 focus-visible:outline-primary focus-visible:-outline-offset-2 focus-visible:relative focus-visible:z-[1]",
      ...
      "data-[range-start]:bg-primary data-[range-start]:text-primary-foreground data-[range-start]:rounded-none data-[range-start]:rounded-l-md",
      "data-[range-end]:bg-primary data-[range-end]:text-primary-foreground data-[range-end]:rounded-none data-[range-end]:rounded-r-md",
