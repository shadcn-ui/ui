...
function AttachmentMedia({
  ...
  variant = "icon",
  ...props
}: React.ComponentProps<typeof ark.div> & VariantProps<typeof attachmentMediaVariants>) {
  return (
    <ark.div
...
function AttachmentGroup({ className, ...props }: React.ComponentProps<typeof ark.div>) {
  return (
    <ark.div
