...
function MessageGroup({ className, ...props }: React.ComponentProps<typeof ark.div>) {
  return (
    <ark.div
...
function MessageAvatar({ className, ...props }: React.ComponentProps<typeof ark.div>) {
  return (
    <ark.div
...
function MessageContent({ className, ...props }: React.ComponentProps<typeof ark.div>) {
  return (
    <ark.div
...
function MessageHeader({ className, ...props }: React.ComponentProps<typeof ark.div>) {
  return (
    <ark.div
...
function MessageFooter({ className, ...props }: React.ComponentProps<typeof ark.div>) {
  return (
    <ark.div
