...
export const Index: Record<string, Record<string, any>> = {
  "radix": {
    ...
    "rtl": {
      ...
      description: "",
      type: "registry:block",
      registryDependencies: ["alert-dialog","avatar","badge","button","button-group","card","checkbox","combobox","direction","dropdown-menu","empty","field","input","input-group","item","label","popover","radio-group","select","separator","sheet","slider","spinner","switch","textarea","tooltip","example"],
      files: [{
