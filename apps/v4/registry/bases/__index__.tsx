...
export const Index: Record<string, Record<string, any>> = {
  "radix": {
    ...
    "blocks": {
      ...
      files: [{
        path: "registry/bases/radix/blocks/blocks.tsx",
        type: "registry:block",
        target: ""
      }],
      component: React.lazy(async () => {
        const mod = await import("@/registry/bases/radix/blocks/blocks.tsx")
        const exportName = Object.keys(mod).find(key => typeof mod[key] === 'function' || typeof mod[key] === 'object') || item.name
        return { default: mod.default || mod[exportName] }
      }),
      categories: undefined,
    ...
    "dashboard-01": {
      ...
      description: "",
      type: "registry:block",
      registryDependencies: ["avatar","badge","button","card","chart","checkbox","drawer","dropdown-menu","input","label","select","separator","sidebar","table","tabs","toggle-group","example"],
      files: [{
        path: "registry/bases/radix/blocks/dashboard-01.tsx",
        type: "registry:block",
        target: ""
      }],
      component: React.lazy(async () => {
        const mod = await import("@/registry/bases/radix/blocks/dashboard-01.tsx")
        const exportName = Object.keys(mod).find(key => typeof mod[key] === 'function' || typeof mod[key] === 'object') || item.name
        return { default: mod.default || mod[exportName] }
      }),
      categories: undefined,
  ...
  "base": {
    ...
    "blocks": {
      ...
      registryDependencies: ["alert-dialog","avatar","badge","button","button-group","card","checkbox","dropdown-menu","empty","field","input","input-group","item","label","popover","radio-group","select","separator","sheet","slider","spinner","switch","textarea","tooltip","example"],
      files: [{
        path: "registry/bases/base/blocks/blocks.tsx",
        type: "registry:block",
        target: ""
      }],
      component: React.lazy(async () => {
        const mod = await import("@/registry/bases/base/blocks/blocks.tsx")
        const exportName = Object.keys(mod).find(key => typeof mod[key] === 'function' || typeof mod[key] === 'object') || item.name
        return { default: mod.default || mod[exportName] }
      }),
      categories: undefined,
    ...
    "dashboard-01": {
      ...
      registryDependencies: ["avatar","badge","button","card","chart","checkbox","drawer","dropdown-menu","input","label","select","separator","sidebar","table","tabs","toggle-group","example"],
      files: [{
        path: "registry/bases/base/blocks/dashboard-01.tsx",
        type: "registry:block",
        target: ""
      }],
      component: React.lazy(async () => {
        const mod = await import("@/registry/bases/base/blocks/dashboard-01.tsx")
        const exportName = Object.keys(mod).find(key => typeof mod[key] === 'function' || typeof mod[key] === 'object') || item.name
        return { default: mod.default || mod[exportName] }
      }),
      categories: undefined,
