...
export default function PreviewExample() {
  return (
    <div className="overflow-x-auto overflow-y-hidden bg-muted contain-[paint] [--gap:--spacing(4)] 3xl:[--gap:--spacing(12)] md:[--gap:--spacing(10)] dark:bg-background style-lyra:md:[--gap:--spacing(6)] style-mira:md:[--gap:--spacing(6)] style-luma:md:[--gap:--spacing(6)]">
      <div className="flex w-full min-w-max justify-center">
        ...
        >
          <div className="flex flex-col p-px [contain-intrinsic-size:380px_1200px] [content-visibility:auto] style-luma:p-4">
            <StyleOverview />
            <TypographySpecimen />
