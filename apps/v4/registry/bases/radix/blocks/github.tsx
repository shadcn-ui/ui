          ...
          {selectedUsers.length ? (
            <AvatarGroup>
              ...
              {selectedUsers.length > 3 && (
                <AvatarGroupCount>+{selectedUsers.length - 3}</AvatarGroupCount>
              )}
            </AvatarGroup>
          ) : (
            <p className="text-muted-foreground text-xs">No users selected.</p>
          )}
        </CardFooter>
      </Card>
    </Example>
