  ...
  return (
    <Example title="Horizontal">
      <ResizablePanelGroup
        ...
        className="style-lyra:rounded-none style-sera:rounded-none min-h-[200px] rounded-lg border"
      >
...
function ResizableNested() {
  return (
    <Example title="Nested">
      <ResizablePanelGroup
        orientation="horizontal"
        className="style-lyra:rounded-none style-sera:rounded-none rounded-lg border"
      >
