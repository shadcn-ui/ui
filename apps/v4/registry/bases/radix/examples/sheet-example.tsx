        ...
        {SHEET_SIDES.map((side) => (
          <Sheet key={side}>
            ...
            >
              ...
              <div className="style-vega:px-4 style-nova:px-4 style-lyra:px-4 style-maia:px-6 style-mira:px-6 style-luma:px-6 style-sera:px-8 style-rhea:px-6 no-scrollbar overflow-y-auto">
