  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Different input field configurations and states.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <FieldGroup>
          ...
          <Field data-disabled>
            <FieldLabel htmlFor="input-disabled-field">
              Disabled Field
            </FieldLabel>
            <Input
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Different textarea field configurations and states.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <FieldGroup>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Different select dropdown configurations and states.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <FieldGroup>
...
function NativeSelectFields() {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Native Select Fields</CardTitle>
        <CardDescription>
          Different native select dropdown configurations and states.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <FieldGroup>
      ...
      <CardContent>
        <FieldGroup>
          ...
          <Field data-disabled orientation="horizontal">
            ...
            <FieldLabel
              htmlFor="checkbox-disabled-field"
              className="font-normal"
            >
              Disabled checkbox
            </FieldLabel>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Different radio button group configurations and states.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <FieldGroup>
          ...
          <RadioGroup className="gap-6">
            <Field orientation="horizontal">
              ...
              <FieldContent>
                <FieldLabel htmlFor="radio-content-1">
                  Enable Touch ID
                </FieldLabel>
                <FieldDescription>
                  Enable Touch ID to quickly unlock your device.
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Different switch toggle configurations and states.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <FieldGroup>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Different slider configurations and states.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <FieldGroup>
          ...
          <Field>
            <FieldLabel htmlFor="slider-brightness">
              Screen Brightness
            </FieldLabel>
            <Slider
          ...
          <Field>
            <FieldLabel htmlFor="slider-color-balance">
              Color Balance
            </FieldLabel>
            <Slider
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Different OTP input configurations and states.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <FieldGroup>
