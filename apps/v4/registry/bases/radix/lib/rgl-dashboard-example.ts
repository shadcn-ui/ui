import type { DashboardRecord } from "@/registry/bases/radix/lib/rgl-dashboard-types"
import { createDefaultLayout, createDefaultWidgets } from "@/registry/bases/radix/lib/rgl-dashboard-types"
