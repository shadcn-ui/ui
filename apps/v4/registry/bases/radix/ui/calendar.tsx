  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: cn(
          "absolute inset-0 bg-popover opacity-0 peer",
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ...
            : "cn-calendar-caption-label flex items-center gap-1 rounded-(--cell-radius) text-sm [&>svg]:size-3.5 [&>svg]:text-muted-foreground peer-focus:outline-2",
