...
import {
  ...
  AccordionItem,
  AccordionTrigger,
} from "@/registry/bases/react-aria/ui/accordion"
  ...
  return (
    <Accordion>
      {questions.map((item, index) => (
        <AccordionItem key={index} id={`question-${index}`}>
      ...
      <CardContent>
        <Tabs defaultSelectedKey="general">
          <TabsList className="w-full">
            <TabsTrigger id="general" className="flex-1">
              General
            </TabsTrigger>
            <TabsTrigger id="billing" className="flex-1">
              Billing
            </TabsTrigger>
            <TabsTrigger id="goals" className="flex-1">
              Goals
            </TabsTrigger>
          </TabsList>
