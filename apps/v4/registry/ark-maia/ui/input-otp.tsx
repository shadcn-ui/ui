...
>(({ className, ...props }, ref) => (
  <PinInput.Control
    ...
    className={cn(
      "has-aria-invalid:ring-destructive/20 dark:has-aria-invalid:ring-destructive/40 has-aria-invalid:border-destructive rounded-4xl has-aria-invalid:ring-[3px] flex items-center has-disabled:opacity-50",
      className
    )}
    {...props}
  />
