  ...
  return (
    <DatePicker.Root inline {...props}>
      <div
        data-slot="calendar"
        className={cn(
          "p-3 [--cell-radius:var(--radius-4xl)] [--cell-size:--spacing(8)] group/calendar w-fit bg-background in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
          className
        )}
      >
