...
import {
  ...
  useComposedRefs,
} from "@/registry/new-york-v4/lib/composition"
  ...
  (props, forwardedRef) => {
    ...
    return (
      <PreviewPrimitive
        ...
        className={cn(
          "data-empty:text-muted-foreground focus-visible:ring-ring cursor-text truncate rounded-sm border border-transparent py-1 text-base focus-visible:ring-1 focus-visible:outline-hidden data-disabled:cursor-not-allowed data-disabled:opacity-50 data-readonly:cursor-default md:text-sm",
          className
        )}
      >
