...
type DropdownMenuSide =
  | NonNullable<React.ComponentProps<typeof DropdownMenuPrimitive.Content>["side"]>
  | LogicalSide
...
function DropdownMenuContent({
  ...
  side,
  ...props
}: Omit<React.ComponentProps<typeof DropdownMenuPrimitive.Content>, "side"> & {
  side?: DropdownMenuSide
}) {
  const direction = useDirection()
  const resolvedSide = side ? resolveSide(direction, side) : undefined
