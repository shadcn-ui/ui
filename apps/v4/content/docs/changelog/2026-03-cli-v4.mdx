...
```bash
npx shadcn@latest add @force-ui/button --dry-run
npx shadcn@latest add @force-ui/button --diff
npx shadcn@latest add @force-ui/button --view
```
...
```bash
npx shadcn@latest add @force-ui/font-inter
```
