...
To add a registry to the index, submit a PR to the `Force UI` repository. See the [registry index documentation](/docs/registry/registry-index) for more details.
