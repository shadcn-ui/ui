...
description: Customize everything. Pick your component library, icons, base color, theme, fonts and create your own version of Force UI.
date: 2025-12-12
---

From the very first commit, the goal of Force UI was to make it customizable.
...
- **Vega** – The classic Force UI look.
