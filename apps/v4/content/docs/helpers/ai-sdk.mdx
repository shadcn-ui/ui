...
components behave exactly as they would in production: text and reasoning stream
word by word, tools move from input to output, and data parts update in place.
