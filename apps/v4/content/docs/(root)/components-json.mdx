...
<Callout className="mt-6" title="Note: You can name the file anything you want">
  `components.json` is the default name and will be referenced throughout the documentation,
  but you can name it anything you want. Provide the `--config-path` option to the CLI to use a different file path.
</Callout>
