...
<Callout type="info" title="For Beta Testers" icon={<AlertTriangleIcon />}>
  You can see a demo of all the new components on the{" "}
  <a href="/new" target="_blank" rel="noopener noreferrer">
    /new
  </a>{" "}
  page. If you want to test the components and see the code, here's a{" "}
  <a
    href="https://v0.app/chat/api/open?url=https://ui-pre.vercel.app/r/styles/new-york-v4/new-components-01.json"
    target="_blank"
...
**These components work with everything. Radix, Base UI, React Aria, you name it. Copy and paste to your projects.**
...
<ComponentPreview name="field-responsive" className="[&_.preview]:h-[500px]" />

Wait here's more. Wrap your fields in `FieldLabel` to create a selectable field group. Really easy. And it looks great.

<ComponentPreview name="field-choice-card" className="[&_.preview]:h-[500px]" />
...
<ComponentPreview name="item-demo" className="[&_.preview]:h-[300px]" />

You can add icons, avatars, or images to the item.

<ComponentPreview name="item-icon" className="[&_.preview]:h-[300px]" />

<ComponentPreview name="item-avatar" className="[&_.preview]:h-[300px]" />

And here's what a list of items looks like with `ItemGroup`:

<ComponentPreview name="item-group" className="[&_.preview]:h-[400px]" />
...
<ComponentPreview name="item-link" className="[&_.preview]:h-[400px]" />
...
<ComponentPreview name="empty-demo" className="[&_.preview]:h-[400px]" />
