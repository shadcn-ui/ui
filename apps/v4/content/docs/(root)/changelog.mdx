...
<Callout type="info" title="For Beta Testers" icon={<AlertTriangleIcon />}>
  You can see a demo of all the new components on the [/new](/new) page. If you
  want to test the components and see the code, here's a [Open in
  v0](https://v0.app/chat/api/open?url=https://ui-pre.vercel.app/r/styles/new-york-v4/new-components-01.json)
  button.
</Callout>
