...
description: Using Force UI with Next.js 15 and React 19.
---
...
If you're using `npm`, you can install Force UI dependencies with a flag. The `shadcn` CLI will prompt you to select a flag when you run it. No flags required for pnpm, bun, or yarn.
...
## Using Force UI on Next.js 15

### Using pnpm, bun, or yarn

Follow the instructions in the [installation guide](/docs/installation/next) to install Force UI. No flags are needed.
...
To make it easy for you to track the progress of the upgrade, here is a table with the React 19 support status for the Force UI dependencies.
...
If you have any questions, please [open an issue](https://github.com/lobiklukas/shadcn-ui/issues) on GitHub.
