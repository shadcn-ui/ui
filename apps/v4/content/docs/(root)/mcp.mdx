...
- **Preview Changes** - See exactly what files will be created or modified before anything is written
- **Selective Updates** - When updating a component, accept incoming changes file by file and keep your local edits where needed
...
- Update the button component but keep my local changes in button.tsx

### Selective Updates

- Show me what would change if I update the card component
- Update dialog but skip the dialog-content.tsx file
