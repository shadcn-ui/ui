...
<ComponentPreview styleName="ark-nova" name="spinner-demo" />
...
<ComponentPreview styleName="ark-nova" name="spinner-custom" />
...
<ComponentPreview styleName="ark-nova" name="spinner-size" />
...
<ComponentPreview styleName="ark-nova" name="spinner-button" />
...
<ComponentPreview styleName="ark-nova" name="spinner-badge" />

### Input Group

<ComponentPreview styleName="ark-nova" name="spinner-input-group" />

### Empty

<ComponentPreview styleName="ark-nova" name="spinner-empty" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="ark-nova" name="spinner-rtl" direction="rtl" />
