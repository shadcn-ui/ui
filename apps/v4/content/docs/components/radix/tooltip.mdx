...
Use the `delayDuration` prop on `TooltipProvider` to change how long the tooltip
waits before opening.

<ComponentPreview styleName="radix-nova" name="tooltip-delay" />
