...
#### 2. Add `locale` prop to the Calendar component
...
#### 4. Update CalendarDayButton to accept locale
...
#### 5. Update date formatting in CalendarDayButton
...
#### 6. Pass locale to DayButton component
...
#### 7. Update RTL-aware CSS classes
