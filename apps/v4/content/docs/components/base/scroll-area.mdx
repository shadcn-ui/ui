...
Use `max-h-*` to let the scroll area grow with its content until it reaches the specified maximum height, then scroll the overflowing content.

```tsx showLineNumbers
<ScrollArea className="max-h-60 w-[350px] rounded-md border p-4">
