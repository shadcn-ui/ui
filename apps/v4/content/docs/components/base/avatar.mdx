...
<ComponentPreview name="avatar-basic" previewClassName="h-72" />

### Badge

Use the `AvatarBadge` component to add a badge to the avatar. The badge is positioned at the bottom right of the avatar.

<ComponentPreview name="avatar-badge" previewClassName="h-72" />
...
<ComponentPreview name="avatar-badge-icon" previewClassName="h-72" />

### Avatar Group

Use the `AvatarGroup` component to add a group of avatars.

<ComponentPreview name="avatar-group" previewClassName="h-72" />

### Avatar Group Count

Use `<AvatarGroupCount>` to add a count to the group.

<ComponentPreview name="avatar-group-count" previewClassName="h-72" />

### Avatar Group with Icon

You can also use an icon inside `<AvatarGroupCount>`.

<ComponentPreview name="avatar-group-count-icon" previewClassName="h-72" />

### Sizes

Use the `size` prop to change the size of the avatar.

<ComponentPreview name="avatar-size" previewClassName="h-72" />

### Dropdown

You can use the `Avatar` component as a trigger for a dropdown menu.

<ComponentPreview name="avatar-dropdown" previewClassName="h-72" />
