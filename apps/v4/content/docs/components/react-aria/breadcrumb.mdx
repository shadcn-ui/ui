...
<ComponentPreview styleName="react-aria-nova" name="breadcrumb-basic" />

### Custom separator

Use a custom component as `children` for `<BreadcrumbSeparator />` to create a custom separator.

<ComponentPreview styleName="react-aria-nova" name="breadcrumb-separator" />

### Dropdown

You can compose `<BreadcrumbItem />` with a `<DropdownMenu />` to create a dropdown in the breadcrumb.

<ComponentPreview styleName="react-aria-nova" name="breadcrumb-dropdown" />
...
<ComponentPreview styleName="react-aria-nova" name="breadcrumb-link" />
