...
<ComponentPreview styleName="react-aria-nova" name="progress-demo" />
...
<ComponentPreview styleName="react-aria-nova" name="progress-label" />

### Controlled

A progress bar that can be controlled by a slider.

<ComponentPreview styleName="react-aria-nova" name="progress-controlled" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="react-aria-nova" name="progress-rtl" direction="rtl" />
