...
<ComponentPreview styleName="react-aria-nova" name="date-picker-demo" />

## Installation

The Date Picker is built using a composition of the `<Popover />` and the `<Calendar />` components.

See installation instructions for the [Popover](/docs/components/react-aria/popover#installation) and the [Calendar](/docs/components/react-aria/calendar#installation) components.
...
<ComponentPreview styleName="react-aria-nova" name="date-picker-basic" />

### Range Picker

A date picker component for selecting a range of dates.

<ComponentPreview styleName="react-aria-nova" name="date-picker-range" />
...
<ComponentPreview styleName="react-aria-nova" name="date-picker-dob" />

### Input

A date picker component with an input field for selecting a date.

<ComponentPreview styleName="react-aria-nova" name="date-picker-input" />

### Time Picker

A date picker component with a time input field for selecting a time.

<ComponentPreview styleName="react-aria-nova" name="date-picker-time" />
