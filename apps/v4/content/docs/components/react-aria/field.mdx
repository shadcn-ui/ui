...
<ComponentPreview styleName="react-aria-nova" name="field-input" />

### Textarea

<ComponentPreview styleName="react-aria-nova" name="field-textarea" />

### Select

<ComponentPreview styleName="react-aria-nova" name="field-select" />

### Slider

<ComponentPreview styleName="react-aria-nova" name="field-slider" />

### Fieldset

<ComponentPreview styleName="react-aria-nova" name="field-fieldset" />
...
<ComponentPreview styleName="react-aria-nova" name="field-radio" />

### Switch

<ComponentPreview styleName="react-aria-nova" name="field-switch" />

### Choice Card

Wrap `Field` components inside `FieldLabel` to create selectable field groups. This works with `RadioItem`, `Checkbox` and `Switch` components.

<ComponentPreview styleName="react-aria-nova" name="field-choice-card" />
