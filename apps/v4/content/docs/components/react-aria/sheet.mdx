...
<ComponentPreview styleName="react-aria-nova" name="sheet-demo" />
...
<ComponentPreview styleName="react-aria-nova" name="sheet-side" />

### No Close Button

Use `showCloseButton={false}` on `SheetContent` to hide the close button.

<ComponentPreview styleName="react-aria-nova" name="sheet-no-close-button" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="react-aria-nova" name="sheet-rtl" direction="rtl" />
