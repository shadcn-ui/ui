...
<ComponentPreview styleName="react-aria-nova" name="tabs-line" />

### Vertical

Use `orientation="vertical"` for vertical tabs.

<ComponentPreview styleName="react-aria-nova" name="tabs-vertical" />

### Disabled

<ComponentPreview styleName="react-aria-nova" name="tabs-disabled" />

### Icons

<ComponentPreview styleName="react-aria-nova" name="tabs-icons" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="react-aria-nova" name="tabs-rtl" direction="rtl" />
