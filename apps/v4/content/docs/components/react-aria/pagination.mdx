...
<ComponentPreview styleName="react-aria-nova" name="pagination-demo" />
...
<ComponentPreview styleName="react-aria-nova" name="pagination-simple" />

### Icons Only

Use just the previous and next buttons without page numbers. This is useful for data tables with a rows per page selector.

<ComponentPreview styleName="react-aria-nova" name="pagination-icons-only" />
...
<ComponentPreview styleName="react-aria-nova" name="pagination-rtl" direction="rtl" />
