...
<ComponentPreview styleName="react-aria-nova" name="sonner-demo" />
...
<ComponentPreview styleName="react-aria-nova" name="sonner-types" />

### Description

<ComponentPreview styleName="react-aria-nova" name="sonner-description" />

### Position

Use the `position` prop to change the position of the toast.

<ComponentPreview styleName="react-aria-nova" name="sonner-position" />
