...
<ComponentPreview styleName="react-aria-nova" name="switch-demo" />
...
<ComponentPreview styleName="react-aria-nova" name="switch-description" />

### Choice Card

Card-style selection where `FieldLabel` wraps the entire `Field` for a clickable card pattern.

<ComponentPreview styleName="react-aria-nova" name="switch-choice-card" />
...
<ComponentPreview styleName="react-aria-nova" name="switch-disabled" />
...
<ComponentPreview styleName="react-aria-nova" name="switch-invalid" />

### Size

Use the `size` prop to change the size of the switch.

<ComponentPreview styleName="react-aria-nova" name="switch-sizes" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="react-aria-nova" name="switch-rtl" direction="rtl" />
