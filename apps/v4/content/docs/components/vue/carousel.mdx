...
> **Why:** I tried to use the `gap` property or a `grid` layout on the `<CarouselContent />` but it required a lot of math and mental effort to get
> the spacing right. I found `pl-[VALUE]` and `-ml-[VALUE]` utilities much
> easier to use.
>
