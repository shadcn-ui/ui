...
<ComponentPreview framework="vue" name="hover-card-demo" previewClassName="h-80" />
...
<ComponentPreview framework="vue" name="hover-card-sides" previewClassName="h-[22rem]" />

## RTL

To enable RTL support in Force UI, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview framework="vue" name="hover-card-rtl" direction="rtl" previewClassName="h-80" />
