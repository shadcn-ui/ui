...
<ComponentPreview framework="ember" name="card-demo" previewClassName="h-[30rem]" />
...
<ComponentPreview framework="ember" name="card-spacing" previewClassName="h-[34rem]" />
...
<ComponentPreview framework="ember" name="card-edge-to-edge" previewClassName="h-[24rem]" />

### Image

Add an image before the card header to create a card with an image.

<ComponentPreview framework="ember" name="card-image" previewClassName="h-[32rem]" />

## RTL

To enable RTL support in Force UI, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview framework="ember" name="card-rtl" direction="rtl" previewClassName="h-[30rem]" />
