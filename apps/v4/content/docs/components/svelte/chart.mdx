...
<ComponentPreview framework="svelte" name="chart-demo" className="theme-blue [&_.preview]:h-auto [&_.preview]:p-0 [&_.preview]:lg:min-h-[404px] [&_.preview>div]:w-full [&_.preview>div]:border-none [&_.preview>div]:shadow-none" hideCode />
...
<ComponentPreview framework="svelte" name="chart-example" previewClassName="h-80" />
...
<ComponentPreview framework="svelte" name="chart-example-grid" previewClassName="h-80" />
...
<ComponentPreview framework="svelte" name="chart-example-axis" previewClassName="h-80" />
...
<ComponentPreview framework="svelte" name="chart-example-tooltip" previewClassName="h-80" />
...
<ComponentPreview framework="svelte" name="chart-example-legend" previewClassName="h-80" />
