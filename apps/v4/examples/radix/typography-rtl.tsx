...
const translations: Translations = {
  ...
  fa: {
    dir: "rtl",
    values: {
      title: "مالیات بر خنده: سرگذشت مالیاتِ شوخی",
      leadParagraph:
        "روزی روزگاری در سرزمینی دور، پادشاهی بسیار تنبل بود که روز خود را به لم دادن بر تخت می‌گذراند. روزی، مشاورانش پیش او آمدند و گفتند که خزانه‌ی کشور خالی شده است.",
      kingsPlan: "طرح پادشاه",
      kingThought: "پادشاه مدت‌ها اندیشید و سرانجام به",
      brilliantPlan: "طرحی درخشان",
      taxJokes: ": تصمیم گرفت برای شوخی‌ها مالیات وضع کند.",
      blockquote:
        '"به هر حال،" او گفت، "همه از یک شوخی خوب لذت می‌برند، پس منصفانه است که برای این امتیاز هزینه‌ای بپردازند."',
      jokeTax: "مالیات شوخی",
      subjectsNotAmused:
        "رعیت پادشاه خوشحال نبودند. آن‌ها غر زدند و شکایت کردند، اما پادشاه مصمم ماند:",
      level1: "سطح اول فکاهه: ۵ سکه طلا",
      level2: "سطح دوم شوخی: ۱۰ سکه طلا",
      level3: "سطح سوم تک‌جمله‌ای: ۲۰ سکه طلا",
      stoppedTelling:
        "در نتیجه مردم از گفتن شوخی‌ها دست کشیدند و کشور در غم فرو رفت. اما یک نفر بود که اجازه نداد حماقت پادشاه او را ناامید کند: دلقکی به نام جوک‌ستر.",
      jokestersRevolt: "شورش دلقک",
      sneaking:
        "دلقک در نیمه‌شب به قلعه نفوذ می‌کرد و شوخی‌ها را در جاهای مختلف می‌گذاشت: زیر بالش پادشاه، در سوپ او و حتی در توالت سلطنتی. پادشاه خشمگین بود اما نتوانست دلقک را متوقف کند.",
      discovered:
        "روزی مردم فهمیدند که شوخی‌های دلقک آن‌قدر خنده‌دار هستند که نتوانستند جلوی خنده‌شان را بگیرند. و وقتی خندیدن آغاز شد، متوقف‌شدنی نبود.",
      peoplesRebellion: "قیام مردم",
      uplifted:
        "مردم که از خنده سرزنده شده بودند، دوباره شروع به گفتن شوخی‌ها و فکاهه‌ها کردند و به زودی همه‌ی کشور درگیر شوخی‌ها شد.",
      kingsTreasury: "خزانه پادشاه",
      peoplesHappiness: "خوشحالی مردم",
      empty: "خالی",
      overflowing: "سرریز",
      modest: "متواضع",
      satisfied: "راضی",
      ...
      ecstatic: "شادی‌زده",
      realized:
        "پادشاه وقتی دید که مردم چقدر شادتر شده‌اند، اشتباهش را فهمید و مالیات شوخی را لغو کرد. دلقک قهرمان نام گرفت و کشور تا ابد شاد زیست.",
      moral:
        "نتیجه داستان: هرگز قدرت یک خنده خوب را دست‌کم نگیر و همیشه از ایده‌های بد دوری کن.",
    },
  },
  ar: {
    dir: "rtl",
