...
const translations: Translations = {
  ...
  fa: {
    dir: "rtl",
    values: {
      question1: "چگونه می‌توانم رمز عبور خود را بازنشانی کنم؟",
      answer1:
        "در صفحه ورود روی «فراموشی رمز عبور» کلیک کنید، آدرس ایمیل خود را وارد کنید و ما یک لینک برای بازنشانی رمز عبور برای شما ارسال خواهیم کرد. این لینک پس از ۲۴ ساعت منقضی می‌شود.",
  
      question2: "آیا می‌توانم طرح اشتراک خود را تغییر دهم؟",
      answer2:
        "بله، شما می‌توانید در هر زمان از تنظیمات حساب کاربری خود طرح اشتراک را ارتقا یا تنزل دهید. تغییرات در دوره بعدی صورتحساب اعمال خواهند شد.",
  
      question3: "چه روش‌های پرداختی را می‌پذیرید؟",
      answer3:
        "ما تمام کارت‌های اعتباری اصلی، PayPal و انتقال‌های بانکی را می‌پذیریم. تمام پرداخت‌ها به‌صورت امن از طریق شرکای پرداخت ما پردازش می‌شوند.",
    },
  },
  ar: {
    dir: "rtl",
