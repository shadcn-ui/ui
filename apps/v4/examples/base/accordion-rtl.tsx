...
const translations: Translations = {
  ...
  fa: {
    dir: "rtl",
    values: {
      question1: "چگونه رمز عبور خود را بازنشانی کنم؟",
      answer1:
        "در صفحه ورود روی 'فراموشی رمز عبور' کلیک کنید، ایمیل خود را وارد کنید و ما لینک بازنشانی را برای شما ارسال می‌کنیم. لینک ظرف 24 ساعت منقضی می‌شود.",
      question2: "آیا می‌توانم پلن اشتراک خود را تغییر دهم؟",
      answer2:
        "بله، می‌توانید در هر زمان پلن خود را از تنظیمات حساب تغییر دهید. تغییرات در دوره صورتحساب بعدی اعمال خواهند شد.",
      question3: "چه روش‌های پرداختی را قبول می‌کنید؟",
      answer3:
        "ما تمام کارت‌های اعتباری اصلی، PayPal و انتقال‌ بانکی را می‌پذیریم. تمام پرداخت‌ها به‌صورت امن پردازش می‌شوند.",
    },
  },
}
