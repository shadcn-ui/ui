...
const translations: Translations = {
  ...
  fa: {
    ...
    values: {
      ...
      secureTransactions: "تمام تراکنش‌ها امن و رمزگذاری شده هستند",
      nameOnCard: "نام روی کارت",
      cardNumber: "شماره کارت",
      cardNumberDescription: "شماره کارت 16 رقمی خود را وارد کنید",
      month: "ماه",
      year: "سال",
      cvv: "CVV",
      monthPlaceholder: "ما",
      ...
      billingAddressDescription: "آدرس صورتحساب مرتبط با روش پرداخت شما",
      sameAsShipping: "مانند آدرس ارسال",
      comments: "نظرات",
      commentsPlaceholder: "نظرات اضافی خود را اضافه کنید",
      submit: "ارسال",
      cancel: "لغو",
    },
  },
