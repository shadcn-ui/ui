...
const translations: Translations = {
  ...
  fa: {
    dir: "rtl",
    values: {
      title: "مالیات خنده: وقایع مالیات جوک",
      leadParagraph:
        "یک بار روزی در سرزمینی دور، شاهی بسیار تنبل بود که تمام روز روی تخت خود دراز می‌کشید. یک روز، مشاوران او با مشکلی نزد او آمدند: پادشاهی از پول تمام می‌شد.",
      kingsPlan: "طرح شاه",
      kingThought: "شاه خیلی فکر کرد، و سرانجام به",
      brilliantPlan: "یک طرح درخشان",
      taxJokes: "رسید: از جوک‌های پادشاهی مالیات می‌گرفت.",
      blockquote:
        '"بهرحال،" گفت، "همه از جوک خوب لذت می‌برند، بنابراین منصفانه است که برای این امتیاز پرداخت کنند."',
      jokeTax: "مالیات جوک",
      subjectsNotAmused:
        "رعایای شاه خشنود نبودند. شکایت می‌کردند، اما شاه بی‌انعطاف بود:",
      level1: "سطح اول از تورش: ۵ سکه طلا",
      level2: "سطح دوم از جوک‌ها: ۱۰ سکه طلا",
      level3: "سطح سوم از جوک‌های کوتاه: ۲۰ سکه طلا",
      stoppedTelling:
        "در نتیجه، مردم جوک گفتن را متوقف کردند و پادشاهی تاریک شد. اما یک نفر بود که نخواست خود را ناامید کند: یک جوکر به نام جوکستر.",
      jokestersRevolt: "شورش جوکستر",
      sneaking:
        "جوکستر شروع به نفوذ به قلعه در نیمه‌های شب کرد و جوک‌ها را در همه جا رها کرد: زیر بالش شاه، در سوپش، حتی در توالت سلطنتی. شاه خشمگین بود، اما نمی‌توانست جوکستر را متوقف کند.",
      discovered:
        "و سپس، یک روز، مردم پادشاهی کشف کردند که جوک‌هایی که جوکستر رها کرده بود آنقدر خنده‌دار بودند که نتوانستند از خنده درنگ کنند. و وقتی شروع به خندیدن کردند، نتوانستند متوقف شوند.",
      peoplesRebellion: "شورش مردم",
      uplifted:
        "مردم پادشاهی احساس درخشش کردند، دوباره جوک و تورش گفتند، و به زودی تمام پادشاهی جزء جوک شد.",
      kingsTreasury: "خزانه شاه",
      peoplesHappiness: "خوشی مردم",
      empty: "خالی",
      overflowing: "سرریز",
      modest: "متواضع",
      satisfied: "رضایت‌مند",
      ...
      ecstatic: "بی‌خود",
      realized:
        "شاه، وقتی دید رعایاش چقدر خوشحال هستند، خطای خود را درک کرد و مالیات جوک را لغو کرد. جوکستر قهرمان اعلام شد و پادشاهی تا ابد خوشبخت بود.",
      moral:
        "عبرت داستان این است: هرگز قدرت خنده خوب را کم‌تر نشمار و از ایده‌های بد احتیاط کن.",
    },
  },
  he: {
    dir: "rtl",
