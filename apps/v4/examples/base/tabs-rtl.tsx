...
const translations: Translations = {
  ...
  fa: {
    ...
    values: {
      ...
      overviewDesc:
        "معیارهای کلیدی خود و فعالیت‌های پروژه اخیر را مشاهده کنید. پیشرفت را در تمام پروژه‌های فعال خود دنبال کنید.",
      overviewContent: "شما ۱۲ پروژه فعال و ۳ کار در انتظار دارید.",
      analyticsTitle: "تجزیه و تحلیل",
      analyticsDesc:
        "عملکرد و معیارهای مشارکت کاربر را دنبال کنید. روند‌ها را نظارت کنید و فرصت‌های رشد را شناسایی کنید.",
      analyticsContent: "مشاهدات صفحه در مقایسه با ماه گذشته ۲۵ درصد افزایش یافته است.",
      reportsTitle: "گزارش‌ها",
      reportsDesc:
        "گزارش‌های تفصیلی خود را تولید و دانلود کنید. داده‌ها را در قالب‌های مختلف برای تجزیه و تحلیل صادر کنید.",
      reportsContent: "شما ۵ گزارش آماده و قابل صادرات دارید.",
      settingsTitle: "تنظیمات",
      settingsDesc:
        "ترجیحات و گزینه‌های حساب خود را مدیریت کنید. تجربه خود را براساس نیازهای خود سفارشی کنید.",
      settingsContent: "اطلاعات، امنیت و تم‌ها را پیکربندی کنید.",
    },
  },
  he: {
    dir: "rtl",
