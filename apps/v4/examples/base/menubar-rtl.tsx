...
const translations: Translations = {
  ...
  fa: {
    ...
    values: {
      ...
      newIncognitoWindow: "پنجره ناشناس جدید",
      share: "اشتراک",
      ...
      paste: " الصاق",
      view: "نمایش",
      bookmarksBar: "نوار نشانک‌ها",
      fullUrls: "آدرس‌های کامل",
      reload: "بارگذاری مجدد",
      forceReload: "بارگذاری مجدد اجباری",
      toggleFullscreen: "تغییر تمام صفحه",
