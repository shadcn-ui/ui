...
>(({ className, children, ...props }, ref) => (
  <ComboboxPrimitive.Item
    ...
    className={cn(
      "gap-2 rounded-md py-1 pr-8 pl-1.5 text-sm data-highlighted:bg-accent data-highlighted:text-accent-foreground not-data-[variant=destructive]:data-highlighted:**:text-accent-foreground [&_svg:not([class*='size-'])]:size-4",
      className
    )}
    {...props}
  >
