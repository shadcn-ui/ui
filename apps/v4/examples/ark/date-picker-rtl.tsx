...
export function DatePickerRtl() {
  ...
  return (
    <DatePicker.Root
      ...
      dir={dir as "ltr" | "rtl"}
    >
      <DatePicker.Control className="inline-flex items-center gap-2">
        <DatePicker.Trigger
          dir={dir}
          className="inline-flex h-9 w-[212px] items-center justify-between rounded-md border border-input bg-background px-3 text-sm shadow-xs transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring [&[data-placeholder]]:text-muted-foreground"
        >
          <DatePicker.ValueText placeholder={t.placeholder} />
      ...
      <Portal>
        <DatePicker.Positioner>
          <DatePicker.Content
            dir={dir}
            className="rounded-lg border bg-popover p-3 text-popover-foreground shadow-md outline-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95"
          >
