...
import { Button, buttonVariants } from "@/examples/ark/ui-rtl/button"
                                ...
                                <DatePicker.TableCellTrigger asChild>
                                  <Button
                                    ...
                                    className={cn(
                                      ...
                                      "data-[range-start]:rounded-(--cell-radius) data-[range-start]:rounded-s-(--cell-radius) data-[range-start]:bg-primary data-[range-start]:text-primary-foreground",
                                      "data-[range-end]:rounded-(--cell-radius) data-[range-end]:rounded-e-(--cell-radius) data-[range-end]:bg-primary data-[range-end]:text-primary-foreground",
