...
function DropdownMenuCheckboxItem({
  ...
  return (
    <MenuPrimitive.CheckboxItem
      ...
      {...props}
    >
      <MenuPrimitive.ItemIndicator className="absolute end-2 flex items-center justify-center">
        <CheckIcon
        />
...
function DropdownMenuSubTrigger({
  ...
  return (
    <MenuPrimitive.TriggerItem
      ...
      data-inset={inset}
      className={cn(
        "gap-1.5 rounded-md px-1.5 py-1 text-sm focus:bg-accent focus:text-accent-foreground not-data-[variant=destructive]:focus:**:text-accent-foreground data-inset:ps-7 data-open:bg-accent data-open:text-accent-foreground [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
