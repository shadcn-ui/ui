...
>(({ className, ...props }, ref) => (
  <PinInput.Input
    ...
    className={cn(
      "relative flex size-8 items-center justify-center border-y border-e border-input bg-transparent text-center text-sm transition-all outline-none first:rounded-s-lg first:border-s last:rounded-e-lg aria-invalid:border-destructive focus-visible:z-10 focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:aria-invalid:border-destructive focus-visible:aria-invalid:ring-destructive/20 dark:bg-input/30 dark:focus-visible:aria-invalid:ring-destructive/40",
      className
    )}
    {...props}
  />
