...
Shipped 2026-05-08 in [PR #52](https://github.com/jnanthak83/lead-design-system/pull/52) (merge `0b2b3ffd8`). **Final scheduled batch before the JES-108 Field/Label closeout.** Five components moved to 🟢: Button, Dialog, Popover, Select, DropdownMenu. Four documented non-parity exceptions (all API-shape, all permanent design-system choices) plus one zero-exception (Popover).
