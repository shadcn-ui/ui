...
function Spinner({
  ...
  return (
    <Loader2Icon materialSymbols="progress_activity" data-slot="spinner" role="status" aria-label="Loading" className={cn(spinnerVariants({ color, size }), className)} {...props} />
  )
}
