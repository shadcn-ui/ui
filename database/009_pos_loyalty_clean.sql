...
ALTER TABLE customers 
    ...
    ADD COLUMN IF NOT EXISTS preferred_outlet_id UUID REFERENCES warehouses(id),
...
ALTER TABLE warehouses 
    ...
    ADD COLUMN IF NOT EXISTS store_manager_id UUID REFERENCES users(id),
...
CREATE INDEX IF NOT EXISTS idx_warehouses_type ON warehouses(outlet_type);
...
-- Update existing warehouses to be outlets (sample data)
-- Note: This assumes you have at least 5 warehouses. Adjust IDs as needed.

-- Sample: Update first 5 warehouses as pilot outlets
UPDATE warehouses 
SET 
    outlet_code = 'JKT001',
    outlet_type = 'Mall',
...
WHERE id = (SELECT id FROM warehouses ORDER BY created_at LIMIT 1 OFFSET 0);

-- Insert POS terminals for pilot outlets
...
BEGIN
    ...
    RAISE NOTICE 'Created/verified % POS and loyalty tables', table_count;
    RAISE NOTICE 'Enhanced customers, products, and warehouses tables';
    RAISE NOTICE 'Created 3 views and 1 trigger';
    RAISE NOTICE 'System ready for POS development';
END $$;
