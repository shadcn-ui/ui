...
describe("formatSearchResultsWithPagination", () => {
  ...
  it("resolves the package runner once for the whole page", async () => {
    const results: SearchResults = {
      items: [
        { name: "button", addCommandArgument: "@shadcn/button", registry: "" },
        { name: "table", addCommandArgument: "@shadcn/table", registry: "" },
        { name: "badge", addCommandArgument: "@shadcn/badge", registry: "" },
      ],
    ...
    expect(output).toContain(
      "Add command: `npx shadcn@latest add @shadcn/table`"
    )
  })
