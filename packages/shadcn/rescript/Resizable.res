...
module ResizablePrimitive = {
  ...
  module Panel = {
    @module("react-resizable-panels")
    external make: React.component<propsWithChildren<string, bool>> = "Panel"
  }

  module Separator = {
    @module("react-resizable-panels")
    external make: React.component<propsWithOptionalChildren<string, bool>> = "Separator"
  }
}
...
module Handle = {
  ...
  let make = (props: propsWithOptionalChildren<string, bool>) => {
    ...
    let primitiveProps = {...props, withHandle: ?None}
    ...
    >
      {withHandle ? <div className="bg-border z-10 flex h-6 w-1 shrink-0 rounded-lg" /> : React.null}
    </ResizablePrimitive.Separator>
  }
}
