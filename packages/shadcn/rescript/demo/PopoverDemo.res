...
let make = () =>
  <Popover>
    <Popover.Trigger render={<Button dataVariant=BaseUi.Types.Variant.Outline />}>
    ...
    <Popover.Content className="w-80">
      <div className="grid gap-4">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground text-sm">{"Set the dimensions for the layer."->React.string}</p>
        </div>
        <div className="grid gap-2">
          ...
          <div className="grid grid-cols-3 items-center gap-4">
            ...
            <Input id="maxWidth" defaultValue="300px" className="col-span-2 h-8">{React.null}</Input>
          </div>
          <div className="grid grid-cols-3 items-center gap-4">
          ...
          <div className="grid grid-cols-3 items-center gap-4">
            ...
            <Input id="maxHeight" defaultValue="none" className="col-span-2 h-8">{React.null}</Input>
          </div>
        </div>
      </div>
    </Popover.Content>
