...
| `MessageScroller.Root`     | Styled frame; lays out the viewport, content, and controls in the provider | `data-pending-scroll` until the opening position applies                                               |
| `MessageScroller.Viewport` | Scrollable frame                                                           | `preserveScrollOnPrepend`; `data-pending-scroll` until the opening position applies                    |
